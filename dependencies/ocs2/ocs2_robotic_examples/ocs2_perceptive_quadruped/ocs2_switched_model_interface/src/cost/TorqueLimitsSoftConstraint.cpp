...
{
  // std::cout << "[TorqueLimitsSoftConstraint::getQuadraticApproximation] started" << std::endl;
  ...
  // std::cout << "[TorqueLimitsSoftConstraint::getQuadraticApproximation] finished" << std::endl;
