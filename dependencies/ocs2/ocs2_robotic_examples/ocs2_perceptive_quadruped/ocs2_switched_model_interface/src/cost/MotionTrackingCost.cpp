                                                 ...
                                                 const ocs2::PreComputation& preComputation) const 
{
  ...
  // std::cout << "[MotionTrackingCost::getParameters]" << std::endl;

  // std::cout << "    time: " << time << std::endl;

  ocs2::vector_t des_state = targetTrajectories.getDesiredState(time).transpose();

  // std::cout << "    des torso position: " << des_state.segment(3, 3).transpose() << std::endl;
...
{
  std::cout << "[MotionTrackingCost::costVectorFunction]" << std::endl;
