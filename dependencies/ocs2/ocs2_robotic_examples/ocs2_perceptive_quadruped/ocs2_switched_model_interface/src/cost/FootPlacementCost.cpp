...
ScalarFunctionQuadraticApproximation FootPlacementCost::getQuadraticApproximation(scalar_t time, const vector_t& state,
                                                                                  ...
                                                                                  const ocs2::PreComputation& preComp) const 
{
  // std::cout << "[FootPlacementCost::getQuadraticApproximation]" << std::endl;
  ...
  for (int leg = 0; leg < NUM_CONTACT_POINTS; ++leg) {
    ...
    if (constraintMatrixPtr != nullptr) {
      ...
      // std::cout << "  linearStateInequalitySoftConstraint.A: " << linearStateInequalitySoftConstraint.A << std::endl;
      // std::cout << "  linearStateInequalitySoftConstraint.h: " << linearStateInequalitySoftConstraint.h << std::endl;
