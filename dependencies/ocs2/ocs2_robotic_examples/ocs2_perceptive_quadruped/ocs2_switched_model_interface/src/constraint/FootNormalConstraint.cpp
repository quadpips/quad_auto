...
{
  // std::cout << "surfaceNormalInWorld: " << surfaceNormalInWorld.transpose() << std::endl;
  // std::cout << "feedforwardPositionInWorld: " << feedforwardPositionInWorld.transpose() << std::endl;
  // std::cout << "feedforwardVelocityInWorld: " << feedforwardVelocityInWorld.transpose() << std::endl;
  // std::cout << "positionGain: " << positionGain << std::endl;
                                        ...
                                        const ocs2::PreComputation& preComp) const 
{
  ...
  // std::cout << "t: " << time << ", o_footPosition: " << o_footPosition.transpose() << std::endl;
  // std::cout << "t: " << time << ", o_footVelocity: " << o_footVelocity.transpose() << std::endl;
  ...
  // std::cout << "t: " << time << ", h[0]: " << h[0] << std::endl;
