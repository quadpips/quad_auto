...
{
  // std::cout << "[SwitchedModelPreComputation::updateFeetPhases]" << std::endl;
  ...
  for (int leg = 0; leg < NUM_CONTACT_POINTS; ++leg) 
  {
    ...
    // std::cout << "    contactFlags_[leg]: " << contactFlags_[leg] << std::endl; 
    // std::cout << "    surfaceNormalsInOriginFrame_[leg]: " << surfaceNormalsInOriginFrame_[leg].transpose() << std::endl; 
    // if (footTangentialConstraintInWorldFrame_[leg])
    // {
    //   std::cout << "    footTangentialConstraintInWorldFrame_[leg]->A: " << footTangentialConstraintInWorldFrame_[leg]->A << std::endl; 
    //   std::cout << "    footTangentialConstraintInWorldFrame_[leg]->b: " << footTangentialConstraintInWorldFrame_[leg]->b << std::endl; 
    // }
  }
}
...
{
  // std::cout << "[SwitchedModelPreComputation::updateMotionReference]" << std::endl;
  ...
  // std::cout << "  basePose: " << basePose.transpose() << std::endl;
  ...
  for (size_t leg = 0; leg < NUM_CONTACT_POINTS; ++leg) 
  {
    ...
    // std::cout << "    motionReference_.footPosition[leg]: " << motionReference_.footPosition[leg].transpose() << std::endl;    
  }
}
...
void SwitchedModelPreComputation::updateIntermediateLinearOutputs(scalar_t t, const vector_t& tapedStateInput) 
{
  ...
  // std::cout << "SwitchedModelPreComputation::updateIntermediateLinearOutputs" << std::endl;
  // std::cout << "    t: " << t << std::endl;
  ...
  for (int leg = 0; leg < NUM_CONTACT_POINTS; ++leg) 
  {
    ...
    // std::cout << "    feetPositionInOriginFrame_[leg]: " << feetPositionInOriginFrame_[leg].transpose() << std::endl;    
