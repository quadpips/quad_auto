...
{
  // std::cout << "[StancePhase::StancePhase]" << std::endl;
  // std::cout << "    nominalFootHoldLocation: " << nominalFootholdLocation_.transpose() << std::endl;
}
...
{
  // std::cout << "[SwingPhase::setFullSwing]" << std::endl;
  ...
  // std::cout << "    swingDuration: " << swingDuration << std::endl;
  ...
  // std::cout << "    liftOffPositionInWorld: " << liftOffPositionInWorld.transpose() << std::endl;
  ...
  // std::cout << "    touchDownPositionInWorld: " << touchDownPositionInWorld.transpose() << std::endl;

  // Apex
  std::vector<SwingNode3d> swingPoints = {start};
  const vector3_t swingVector = touchDownPositionInWorld - liftOffPositionInWorld;
  // std::cout << "    swingVector: " << swingVector.transpose() << std::endl;
  scalar_t xy_thresh = 0.03;
  if (swingVector.head<2>().norm() > xy_thresh) 
  {
    // std::cout << "    case 1 - xy motion" << std::endl;
    ...
    // std::cout << "    swingTrajectoryNormal: " << swingTrajectoryNormal.transpose() << std::endl;
    ...
    if (terrainModel != nullptr) 
    {
      ...
      // std::cout << "    heightProfile: " << std::endl;
      for (const auto& point : heightProfile) 
      {
        ...
        // std::cout << "      heightRelativeToSwingLine: " << heightRelativeToSwingLine << std::endl;
        const scalar_t relativeHeightProjectedOnNormal = heightRelativeToSwingLine * swingTrajectoryNormal.z();
        // std::cout << "      relativeHeightProjectedOnNormal: " << relativeHeightProjectedOnNormal << std::endl;
        if (relativeHeightProjectedOnNormal > maxObstacleHeight) 
        {
          maxObstacleHeight = relativeHeightProjectedOnNormal;
        }
      }
      // std::cout << "    raw maxObstacleHeight: " << maxObstacleHeight << std::endl;
      ...
      // std::cout << "    final maxObstacleHeight: " << maxObstacleHeight << std::endl;

      // if (maxObstacleHeight > 0.0) 
      // {
      //   std::cout << "    terrain adaptation applied with maxObstacleHeight: " << maxObstacleHeight << std::endl;
      // }
    }
    ...
    for (const auto& node : swingProfile.nodes) 
    {
      ...
      // std::cout << "    midPoint.position: " << midPoint.position.transpose() << std::endl;
      ...
      // std::cout << "    midPoint.velocity: " << midPoint.velocity.transpose() << std::endl;
      swingPoints.push_back(midPoint);
    }
  } else {  // (cases where target is above or intersecting with current position)
    // std::cout << "    case 1 - no xy motion" << std::endl;
...
{
  // std::cout << "[SwingPhase::setHalveSwing]" << std::endl;
