...
#include "ocs2_go2_models/QuadrupedPinocchioMapping.h"
 ...
 */
extern template class go2::tpl::QuadrupedKinematics<ocs2::scalar_t>;
extern template class go2::tpl::QuadrupedKinematics<ocs2::ad_scalar_t>;
