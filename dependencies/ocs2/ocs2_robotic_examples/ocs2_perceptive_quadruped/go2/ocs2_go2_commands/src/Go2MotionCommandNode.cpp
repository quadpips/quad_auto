...
#include "ocs2_go2_commands/MotionCommandController.h"
#include "ocs2_go2_commands/MotionCommandDummy.h"

int main(int argc, char* argv[]) 
{
  const std::string robotName = "go2";
  std::string motionFile = ament_index_cpp::get_package_share_directory("ocs2_go2_commands") + "/config/motions.info";
