...
#include "ocs2_go2_commands/MotionCommandInterface.h"
...
#include "ocs2_go2_commands/LoadMotions.h"
...
namespace switched_model
{
  ...
  MotionCommandInterface::MotionCommandInterface(const std::string &configFile)
  {
    ...
    const std::string motionFilesPath = ament_index_cpp::get_package_share_directory("ocs2_go2_commands") + "/config/motions/";
