...
class CustomSwingPlanningVisualizer : public ocs2::SolverSynchronizedModule {
 public:
  ...
  CustomSwingPlanningVisualizer(const SwingTrajectoryPlanner& swingTrajectoryPlanner,
