...
class CustomQuadrupedPointfootInterface : public CustomQuadrupedInterface 
{
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  using CustomQuadrupedInterface::synchronized_module_ptr_array_t;

  CustomQuadrupedPointfootInterface(const kinematic_model_t& kinematicModel, const ad_kinematic_model_t& adKinematicModel,
                                    ...
                                    std::string baseName); // , const std::string & envFile 

  ~CustomQuadrupedPointfootInterface() override = default;
