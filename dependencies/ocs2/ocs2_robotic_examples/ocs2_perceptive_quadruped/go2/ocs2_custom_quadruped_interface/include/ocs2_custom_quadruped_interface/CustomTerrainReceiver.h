...
class CustomTerrainReceiverSynchronizedModule : public ocs2::SolverSynchronizedModule {
 public:
  CustomTerrainReceiverSynchronizedModule(ocs2::Synchronized<TerrainModel>& terrainModel, 
                                          const rclcpp::Node::SharedPtr &node,
                                          const bool & vis = true);
  ~CustomTerrainReceiverSynchronizedModule() override = default;
