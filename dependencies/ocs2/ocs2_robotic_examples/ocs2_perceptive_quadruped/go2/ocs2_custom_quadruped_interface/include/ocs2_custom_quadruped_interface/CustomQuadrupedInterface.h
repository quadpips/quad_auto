...
class CustomQuadrupedInterface : public ocs2::RobotInterface 
{
 public:
   ...
   */
  CustomQuadrupedInterface(const kinematic_model_t& kinematicModel, const ad_kinematic_model_t& adKinematicModel, const com_model_t& comModel,
  ...
  /** Destructor */
  ~CustomQuadrupedInterface() override = default;
  ...
  /** Access to final cost settings */
  const state_matrix_t& terminalCostSettings() const { return settings_.Qf_; };
 ...
 protected:
  ...
  std::unique_ptr<ocs2::StateCost> createMotionTrackingTerminalCost() const;
 ...
 private:
  ...
  // void populateTerrain(const std::string & envFile);
