...
namespace switched_model 
{
  ...
  CustomTerrainPlaneVisualizer::CustomTerrainPlaneVisualizer(const rclcpp::Node::SharedPtr &node) : node_(node) 
  {
    terrainPublisher_ = node_->create_publisher<visualization_msgs::msg::Marker>("/ocs2_go2/localTerrain", 1);
  }

  void CustomTerrainPlaneVisualizer::update(scalar_t time, const TerrainPlane &terrainPlane)
  {
    // Headers
  ...
  CustomTerrainPlaneVisualizerSynchronizedModule::CustomTerrainPlaneVisualizerSynchronizedModule(const SwingTrajectoryPlanner &swingTrajectoryPlanner,
                                                                                      const rclcpp::Node::SharedPtr &node)
        : swingTrajectoryPlanner_(&swingTrajectoryPlanner), planeVisualizer_(node) {}

  void CustomTerrainPlaneVisualizerSynchronizedModule::postSolverRun(const ocs2::PrimalSolution &primalSolution)
  {
