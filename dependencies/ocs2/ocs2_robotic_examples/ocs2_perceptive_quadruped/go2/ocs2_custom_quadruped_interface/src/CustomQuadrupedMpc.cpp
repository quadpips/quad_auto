...
std::unique_ptr<ocs2::MPC_BASE> getDdpMpc(const CustomQuadrupedInterface& quadrupedInterface, 
...
std::unique_ptr<ocs2::MPC_BASE> getSqpMpc(const CustomQuadrupedInterface& quadrupedInterface, 
                                          const ocs2::mpc::Settings& mpcSettings,
