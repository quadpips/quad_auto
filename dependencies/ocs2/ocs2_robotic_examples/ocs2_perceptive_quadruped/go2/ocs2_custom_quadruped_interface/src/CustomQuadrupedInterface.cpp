...
CustomQuadrupedInterface::CustomQuadrupedInterface(const kinematic_model_t& kinematicModel, const ad_kinematic_model_t& adKinematicModel,
                                                    ...
                                                    std::vector<std::string> jointNames, std::string baseName) // , const std::string& envFile 
...
std::unique_ptr<ocs2::PreComputation> CustomQuadrupedInterface::createPrecomputation() const {
...
std::unique_ptr<ocs2::StateInputCost> CustomQuadrupedInterface::createMotionTrackingCost() const {
  return std::unique_ptr<ocs2::StateInputCost>(new MotionTrackingCost(costSettings(), getKinematicModelAd(), modelSettings()));
}

std::unique_ptr<ocs2::StateCost> CustomQuadrupedInterface::createMotionTrackingTerminalCost() const {
  return std::unique_ptr<ocs2::StateCost>(new MotionTrackingTerminalCost(std::move(terminalCostSettings())));
}

// std::unique_ptr<ocs2::StateCost> CustomQuadrupedInterface::createMotionTrackingTerminalCost(matrix_t Q) const {
//   return std::unique_ptr<ocs2::StateCost>(new MotionTrackingTerminalCost(std::move(Q)));
// }

std::unique_ptr<ocs2::StateCost> CustomQuadrupedInterface::createFootPlacementCost() const {
...
std::unique_ptr<ocs2::StateCost> CustomQuadrupedInterface::createCollisionAvoidanceCost() const {
  return std::unique_ptr<ocs2::StateCost>(
      new CollisionAvoidanceCost(ocs2::RelaxedBarrierPenalty::Config(modelSettings().muSdf_, modelSettings().deltaSdf_)));
}

std::unique_ptr<ocs2::StateInputCost> CustomQuadrupedInterface::createJointLimitsSoftConstraint() const 
{
...
std::unique_ptr<ocs2::StateInputCost> CustomQuadrupedInterface::createTorqueLimitsSoftConstraint(const joint_coordinate_t& nominalTorques) const {
...
std::unique_ptr<ocs2::SystemDynamicsBase> CustomQuadrupedInterface::createDynamics() const {
...
std::unique_ptr<ocs2::StateInputConstraint> CustomQuadrupedInterface::createZeroForceConstraint(size_t leg) const {
  return std::unique_ptr<ocs2::StateInputConstraint>(new ZeroForceConstraint(leg, *getSwitchedModelModeScheduleManagerPtr()));
}

std::unique_ptr<ocs2::StateInputConstraint> CustomQuadrupedInterface::createFootNormalConstraint(size_t leg) const {
...
std::unique_ptr<ocs2::StateInputConstraint> CustomQuadrupedInterface::createEndEffectorVelocityConstraint(size_t leg) const {
...
std::unique_ptr<ocs2::StateInputCost> CustomQuadrupedInterface::createFrictionConeCost() const {
...
CustomQuadrupedInterface::Settings loadCustomQuadrupedSettings(const std::string& pathToConfigFile) 
{
  CustomQuadrupedInterface::Settings settings;
  ...
  // Qf
  // ocs2::loadData::loadEigenMatrix(pathToConfigFile, "Qfinal", settings.Qf_);

  return settings;
}

}  // namespace ocs2_custom_quadruped_interface
