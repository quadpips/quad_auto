...
def generate_launch_description():
    ld = launch.LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            executable='ocs2_go2_mpc_mpc_node',
            name='ocs2_go2_mpc_mpc_node',
            prefix="",
            output='screen',
            parameters=[
                {
        ...
        launch_ros.actions.Node(
            package='ocs2_go2_mpc',
            executable='ocs2_go2_mpc_dummy_mrt_node',
            name='ocs2_go2_mpc_dummy_mrt_node',
