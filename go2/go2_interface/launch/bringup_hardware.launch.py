...
def generate_launch_description():
    ...
    go2_xacro_file_path = os.path.join(go2_description_path, "xacro", "robot_realsense.xacro")
    ...
    ld = launch.LaunchDescription([
        ...
        # launch_ros.actions.Node(
        #     package='realsense_img_preprocessor',  
        #     executable='realsense_img_preprocessor_node',
        #     name='realsense_img_preprocessor_node',
        #     output='log',
        #     parameters=[
        #         {
        #             "use_sim_time": LaunchConfiguration("use_sim_time"),
